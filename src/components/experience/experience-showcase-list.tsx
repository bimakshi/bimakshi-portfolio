...
export default function ExperienceShowcaseList(
  ...
  return (
    <div
      id="experience"
      className="mx-auto my-24 max-w-7xl px-6 sm:px-14 md:my-32 md:px-20"
    >
      <h2 className="mb-14 w-full text-center text-3xl font-extrabold tracking-tight text-accent sm:text-4xl md:text-5xl">
        {props.title}
      </h2>
